const en = {
  ...
  'audits.switch_tooltip': 'Create a client from this audit\'s data',
  // Switch to client — real promotion (audit/prospect → client)
  'audits.switch_confirm': 'Create the client "{name}" from this audit\'s data?',
  'audits.switch_confirm_yes': 'Create client',
  'audits.switch_cancel': 'Cancel',
  'audits.switch_working': 'Creating…',
  'audits.switch_done': 'Client created',
  'audits.switch_error': 'Promotion failed',
  'audits.client_badge': 'Client',
  'audits.client_badge_tooltip': 'Open the client linked to this audit',
  ...
  // Single V4 onboarding: a new client starts as a New-audit prospect.
  'clients.new_client_button': '+ New client (audit)',
  'clients.empty_start_audit': 'Start a new audit — promote it with "Switch to client" →',
  ...
  // V4 — Results screen (Audit Results, UX-UI Bibbia sheets 3/6)
  'v4res.title': 'Audit results',
  'v4res.tab_overview': 'Overview',
  'v4res.tab_summary': 'Executive Summary',
  'v4res.state_running': 'running',
  'v4res.state_needs_decision': 'needs decision',
  'v4res.state_draft': 'draft',
  'v4res.state_published': 'published',
  'v4res.state_error': 'errors',
  'v4res.view_relative': 'Relative (leader-index)',
  'v4res.view_absolute': 'Absolute (raw 0-100)',
  'v4res.refdate': 'REF_DATE',
  'v4res.loading': 'Loading…',
  'v4res.autorefresh': 'Auto-refresh every 5 seconds while drivers run.',
  'v4res.no_jobs': 'No jobs were created for this analysis. It was created without starting it.',
  'v4res.start_pending': 'Start queued drivers',
  'v4res.starting': 'Starting…',
  'v4res.retry': 'Relaunch',
  'v4res.retrying': 'Relaunching…',
  'v4res.retry_hint': 'Requeues failed or stuck drivers without recreating the analysis. Completed drivers, edits and pending questions are untouched.',
  'v4res.save_publish': 'Save & Publish',
  'v4res.drafts_pending': 'draft edits',
  'v4res.no_drafts': 'no draft edits',
  'v4res.publish_blocked_running': 'Not publishable while drivers are still running.',
  'v4res.radar_title': 'Driver radar',
  'v4res.radar_client': 'Client',
  'v4res.radar_absolute_note': 'Absolute view: only drivers with an intrinsic 0-100 score (Development + AI Visibility). Excluded here:',
  'v4res.overlay_competitors': 'Overlay competitors',
  'v4res.no_radar_data': 'No completed driver to chart yet.',
  'v4res.score': 'Score',
  'v4res.raw': 'raw',
  'v4res.rank': 'rank',
  'v4res.leader': 'leader',
  'v4res.edited_badge': 'edited by hand',
  'v4res.open_tab': 'Open driver tab',
  'v4res.resolve': 'Resolve',
  'v4res.band_critical': 'Critical',
  'v4res.band_weak': 'Weak',
  'v4res.band_good': 'Good',
  'v4res.band_excellent': 'Excellent',
  'v4res.family_business': 'Business',
  'v4res.family_development': 'Development',
  'v4res.sec_score': 'Score',
  'v4res.sec_summary': 'Summary',
  'v4res.sec_data': 'Data & metrics',
  'v4res.sec_issues': 'Issues',
  'v4res.sec_solutions': 'Solutions',
  'v4res.client': 'Client',
  'v4res.competitors': 'Competitors',
  'v4res.relative_only_note': 'This driver only has the Relative view (leader-index); the values below are relative.',
  'v4res.tier_label': 'tier',
  'v4res.disco_criteria': 'non-brand keywords in top {pos} with volume >= {vol}',
  'v4res.awareness_criteria': 'branded keywords in top 100 (domain-grounded), sum of monthly search volume',
  'v4res.awareness_brand_terms': 'brand terms used',
  'v4res.histogram_title': 'Client vs competitors',
  'v4res.evidence_title': 'Evidence',
  'v4res.evidence_site': 'Evidence site',
  'v4res.not_measured': 'not measured',
  'v4res.no_value': 'no value',
  'v4res.driver_error': 'DRIVER ERROR',
  'v4res.driver_pending': 'This driver is still queued or running. The tab updates automatically.',
  'v4res.edit_button': 'Edit score and comment',
  'v4res.close': 'Close',
  'v4res.gen_insights': 'Generate insights',
  'v4res.gen_insights_running': 'Generating insights…',
  'v4res.insights_placeholder': 'No AI insight yet for this driver. Generate the insights to fill Summary, Issues and Solutions.',
  'v4res.insights_error': 'Insight generation failed',
  'v4res.hallucination_flags': 'Numbers not verified against the payload',
  'v4res.priority': 'priority',
  'v4res.relevance': 'strategic relevance',
  'v4res.solutions_business_note': 'Business driver: solutions are strategic and live in the Executive Summary (solution matrix); the insights above carry the per-driver reading.',
  'v4res.no_issues': 'No issues extracted for this driver.',
  'v4res.sum_placeholder': 'No Executive Summary yet. Generate the insights: the summary is produced at the end of the per-driver sequence.',
  'v4res.sum_scorecard': 'Scorecard overview',
  'v4res.sum_correlations': 'Key correlations',
  'v4res.sum_priorities': 'Strategic priorities roadmap',
  'v4res.sum_alerts': 'Critical alerts',
  'v4res.sum_months': 'months',
  'v4res.sum_impact': 'impact',
  'v4res.sum_drivers': 'drivers',
  'v4res.pub_title': 'Save & Publish',
  'v4res.pub_intro': 'Publishing stamps every draft edit and, per spec, re-runs in one batch only the drivers you edited.',
  'v4res.pub_rerun_list': 'Drivers that will be re-run',
  'v4res.pub_no_rerun': 'No driver will be re-run.',
  'v4res.pub_kept_edits': 'Edits that will be kept (a re-run never overwrites an edited score or comment)',
  'v4res.pub_ineligible': 'Edited but not re-runnable',
  'v4res.pub_rerun_toggle': 'Re-run edited drivers in batch',
  'v4res.pub_confirm': 'Publish',
  'v4res.pub_cancel': 'Cancel',
  'v4res.pub_publishing': 'Publishing…',
  ...
  'v4content.client_required': 'Client mandatory',
  'v4content.competitor_optional': 'competitors optional',
  'v4content.answered': 'answered',
  'v4content.score_preview': 'Template score',
  'v4content.incomplete': 'incomplete',
  'v4content.save': 'Save answers (draft)',
  'v4content.saving': 'Saving…',
  'v4content.saved': 'Answers saved.',
  'v4content.save_error': 'Save failed',
  'v4content.resume_driver': 'Restart the Content driver',
  ...
  'v4setup.subtitle':
    'Client + up to 4 competitors. The 4 Business drivers are pre-flagged and mandatory; Development drivers are optional. The setup can be saved as a draft at any time.',
  'v4setup.step1': 'Project data',
  'v4setup.step2': 'Competitors',
  'v4setup.step3': 'Drivers',
  'v4setup.step4': 'Additional parameters',
  'v4setup.step5': 'Launch',
  'v4setup.step1_hint': 'The site the report is about, and the context that calibrates the AI comments.',
  'v4setup.step2_hint':
    'Up to 4, with the brand name of each. Mandatory: the Business driver scores are an index relative to the set, not an absolute value.',
  'v4setup.step3_hint':
    'Business drivers first, pre-flagged and mandatory. Each enabled driver opens its inline configuration; drivers run in parallel.',
  'v4setup.step4_hint': 'All optional: output guardrails, knowledge documents, notes for the model.',
  'v4setup.step5_hint': 'Review and launch. The CTA is enabled only when the required fields are filled.',
  'v4setup.client_site': 'Client',
  'v4setup.domain': 'Domain',
  'v4setup.brand_name': 'Brand name',
  'v4setup.brand_variants': 'Brand variants (comma separated)',
  'v4setup.brand_variants_hint': 'Used to identify the brand name and its variants (Awareness keyword cluster).',
  'v4setup.countries': 'Analysis country',
  'v4setup.countries_hint': 'One or more markets. The first one is the primary market for the SEO data sources.',
  'v4setup.site_type': 'Site type',
  'v4setup.site_type_hint': 'Orients AI comments and the suggested page templates for Content.',
  'v4setup.sector': 'Sector / Industry',
  'v4setup.sector_free_placeholder': 'or type it freely, e.g. cruise travel',
  'v4setup.sector_hint': 'Contextualises comments and drives the expected-schema preset.',
  'v4setup.seo_maturity': 'SEO maturity level',
  'v4setup.seo_maturity_hint': 'Adjusts the technical register of generated comments.',
  'v4setup.maturity_low': 'Low',
  'v4setup.maturity_medium': 'Medium',
  'v4setup.maturity_high': 'High',
  'v4setup.target_audience': 'Target audience',
  'v4setup.target_audience_placeholder': 'e.g. women 25-45, urban',
  'v4setup.audience_both': 'Both',
  'v4setup.output_language': 'Output language',
  'v4setup.competitor_domain': 'Competitor URL',
  'v4setup.competitor_brand': 'Brand name',
  'v4setup.add_competitor': 'Add competitor',
  'v4setup.remove': 'Remove',
  'v4setup.mandatory_badge': 'Pre-flagged · mandatory',
  'v4setup.data_source': 'Data source',
  'v4setup.needs_competitor': 'Requires at least one competitor (STEP 2) to launch.',
  'v4setup.jhorizon_label': 'J-Horizon insights recap (optional)',
  'v4setup.jhorizon_placeholder': 'Paste here the insights recap from J-Horizon…',
  'v4setup.jhorizon_hint':
    'If provided now, the driver skips its pause and elaborates it into charts and visuals directly.',
  'v4setup.clusters_label': 'Thematic clusters',
  'v4setup.clusters_placeholder': 'e.g. Destinations, Ships, Onboard life — Enter or comma to add',
  'v4setup.clusters_hint':
    'Macro-themes relevant to the brand, used to build the cluster table in the Discoverability section.',
  'v4setup.crawl_upload_label': 'Upload crawl — Screaming Frog (.csv/.xlsx, optional)',
  'v4setup.crawl_upload_hint': 'Feeds the Issues tab of the Compliance driver.',
  'v4setup.backlink_upload_label': 'Backlink export (.csv/.xlsx, optional)',
  'v4setup.backlink_upload_hint':
    'Full backlink list from Ahrefs: enables qualitative analysis on link target URLs and gap areas.',
  'v4setup.templates_label': 'Page templates',
  ...
  'v4setup.competitor_urls': 'Template URLs per competitor (optional)',
  'v4setup.hide': 'Hide',
  'v4setup.ga_gsc': 'GA / GSC integration',
  'v4setup.ga_gsc_hint':
    'Useful for the ongoing/client component, not for current one-off analyses. Feeds Discoverability with real traffic data.',
  'v4setup.future_badge': 'Future',
  'v4setup.connect': 'Connect',
  'v4setup.blocklist': 'Words to avoid',
  'v4setup.blocklist_placeholder': "e.g. excellent, outstanding — Enter or comma to add",
  'v4setup.blocklist_hint': 'Terms/adjectives the AI must not use. Professional tone of voice, no AI writing tells.',
  'v4setup.max_insights': 'Max insights',
  'v4setup.max_insights_hint': 'Maximum number of insights/actions per driver, to avoid hallucination.',
  'v4setup.knowledge_docs': 'Knowledge documents (optional)',
  'v4setup.knowledge_docs_hint': 'Tender brief, brand book, guidelines: they contextualise generated insights.',
  'v4setup.notes': 'Additional notes',
  'v4setup.notes_placeholder': 'Known constraints, project history, unstructured info to pass to the model…',
  'v4setup.summary_site': 'Site',
  'v4setup.summary_competitors': 'Competitors',
  'v4setup.summary_drivers': 'Drivers',
  'v4setup.summary_attachments': 'Attachments',
  'v4setup.missing_title': 'To launch, complete:',
  'v4setup.launch_note':
    "Drivers process in parallel (async). The audit enters 'draft' state and you can browse completed drivers while others run.",
  'v4setup.launch_cta': 'Launch analysis',
  'v4setup.launching': 'Launching…',
  'v4setup.back': 'Back',
  'v4setup.next': 'Next',
  'v4setup.save_draft': 'Save draft',
  'v4setup.saving': 'Saving…',
  'v4setup.draft_saved': 'Draft saved at',
  'v4setup.draft_needs_domain': 'Enter the domain first: a draft needs at least the site it is about.',
  'v4setup.uploading': 'Uploading…',
  'v4setup.upload_parse_note': 'The file is stored with the setup; parsing inside the driver is coming next.',
  'v4setup.req_domain': 'Domain (STEP 1)',
  'v4setup.req_brand': 'Brand name (STEP 1)',
  'v4setup.req_country': 'At least one analysis country (STEP 1)',
  'v4setup.req_site_type': 'Site type (STEP 1)',
  'v4setup.req_competitor': 'At least one competitor (STEP 2)',
  'v4setup.req_competitor_brand': 'Brand name for every competitor (STEP 2)',
  'v4setup.req_clusters': 'Thematic clusters: between 3 and 10, or none (STEP 3)',
  'v4setup.req_max_insights': 'Max insights must be a positive integer (STEP 4)',
  'v4setup.err_unknown': 'unknown error',
