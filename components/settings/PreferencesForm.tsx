...
/**
 * Preferences island of /settings — the pre-existing profile + password
 * form, extracted unchanged from the old client-side settings page so the
 * page itself could become a server component (Bibbia 04: Settings =
 * APIs / data sources / preferences).
 */
